...
def processWithColor(imgPath, scale_factor):
...
def process(imgPath, scale_factor=15, color=False):
    if color:
        return processWithColor(imgPath, scale_factor)
...
process("static/images/DuckScenery.jpg", 8)
